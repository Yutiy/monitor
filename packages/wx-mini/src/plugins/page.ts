import { WxPageEvents, WxBreadcrumbTypes, WxEventTypes, voidFun } from '@bdw/monitor-shared'
import { BasePluginType } from '@bdw/monitor-types'
import { firstStrToLowerCase, isEmptyObject, replaceOld } from '@bdw/monitor-utils'
