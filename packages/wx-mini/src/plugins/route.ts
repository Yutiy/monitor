import { ErrorTypes, WxBaseEventTypes, WxBreadcrumbTypes, WxEventTypes, WxRouteEvents } from '@bdw/monitor-shared'
import { getCurrentRoute, Severity, variableTypeDetection } from '@bdw/monitor-utils'
