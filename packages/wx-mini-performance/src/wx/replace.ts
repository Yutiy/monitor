import { replaceOld, isEmptyObject } from '@bdw/monitor-utils'
import Store from '../core/store'
import HandleEvents from './handleEvents'
import { WxPerformanceAnyObj } from '../types'
import { WxPerformanceItemType, WxListenerTypes } from '../constants'
