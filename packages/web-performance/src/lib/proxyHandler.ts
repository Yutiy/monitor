 ...
 * @param afterHandler
 */
export function proxyXhr(beforeHandler: (...args: Array<any>) => void, afterHandler: (...args: Array<any>) => void): void {
 ...
 * @param afterHandler
 */
export function proxyFetch(beforeHandler: (...args: Array<any>) => void, afterHandler: (...args: Array<any>) => void): void {
 ...
 * @param handler
 */
export function proxyHistory(handler: (...args: Array<any>) => void) {
  if (window.history) {
