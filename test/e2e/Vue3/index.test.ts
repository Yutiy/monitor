import { BaseBreadcrumbTypes, BreadcrumbCategorys, ErrorTypes, SDK_NAME, SDK_VERSION } from '@bdw/monitor-shared'
import { vue3Url } from '@/test/config'
import { TransportDataType, ReportDataType } from '@bdw/monitor-types'
import { Severity } from '@bdw/monitor-utils'
import puppeteer from 'puppeteer'
import {} from '@bdw/monitor-types'
import { BrowserClient } from '@bdw/monitor-browser'
